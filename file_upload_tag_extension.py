        ...
        try:
            ...
            for match in matches:
                ...
                if paramName in BurpExtender.file_mappings:
                    ...
                    try:
                        # Read file content
                        fileContent = self.readFileAsBytes(filePath)
                        ...
                        newRequest = self.replaceInRequest(newRequest, tag, fileContent)
                        modified = True
                        
                        # Also replace corresponding typefile tag if exists
                        typefileTag = "<@typefile" + paramName.replace("getfile", "") + "@>"
                        if typefileTag in self._helpers.bytesToString(newRequest):
                        ...
                        print("ERROR: Failed to process file for <@" + paramName + "@>: " + str(e))
